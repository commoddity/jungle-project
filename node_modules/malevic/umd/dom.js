...
(function (global, factory) {
    ...
    var specialAttrs = new Set(['key', 'attached', 'detached', 'updated']);
    ...
    var ComponentVNode = (function (_super) {
        ...
        ComponentVNode.prototype.createContext = function (context) {
            ...
            return {
                ...
                parent: parent,
                attached: function (fn) { return (store[symbols.ATTACHED] = fn); },
                detached: function (fn) { return (store[symbols.DETACHED] = fn); },
                updated: function (fn) { return (store[symbols.UPDATED] = fn); },
                refresh: function () {
                    if (_this.lock) {
        ...
        ComponentVNode.prototype.unbox = function (context) {
            ...
            var unboxed = null;
            try {
                unboxed = Component.apply(void 0, [props].concat(children));
            }
            finally {
